      ...
      <main className="flex min-h-screen flex-col items-center  bg-gradient-to-b from-white via-white to-blue-400 w-full">
        ...
        <div className="px-6 md:mt-24 w-full flex flex-col items-center">
          <div className="tabs flex justify-center md:justify-start">
            <a
              className={`tab tab-bordered text-base font-semibold px-6 ${activeTab === "properties" ? "tab-active" : ""
                }`}
            ...
            <a
              className={`tab tab-bordered text-base font-semibold px-6 ${activeTab === "collectors" ? "tab-active" : ""
                }`}
            ...
            <a
              className={`tab tab-bordered text-base font-semibold px-6 ${activeTab === "contracts" ? "tab-active" : ""
                }`}
