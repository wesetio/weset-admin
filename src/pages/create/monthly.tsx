  ...
  return (
    <>
        <motion.div
            ...
            exit={{ opacity: 0 }}
            className='flex flex-col items-center min-h-screen bg-gradient-to-b from-blue-100/50'
        >
          <div className='w-11/12'>
              <div className="text-xs md:text-sm breadcrumbs my-6">
                <ul>
                  <li>
                    <Link href="/">
              ...
              <h3 className='text-2xl font-semibold md:text-3xl'>Create Monthly Contract on Polygon</h3>
              <div className='text-sm md:text-base'>Not sure if this is the right contract? Find the best one for you with our onboarding tool, or learn more about the monthly contract here.</div>
              <hr className='my-4' />
          </div>
            <div className='flex flex-col-reverse md:flex-row gap-x-16 w-11/12 mt-5 md:mt-10'>
                <div className='w-full md:w-1/2'>
                    <div className='bg-white w-full h-[500px] shadow rounded-md'></div>
                </div>
                <div className='w-full md:w-1/2'>
                        <form>
                          <div className="mb-4">
